...
param sampleAppServiceName string = 'sampleapp'
...
// Container app
module sampleApp 'app/app.bicep' = {
  name: sampleAppServiceName
  scope: rg
  params: {
    appName: !empty(containerAppsAppName) ? '${containerAppsAppName}-sampleapp' : '${abbrs.appContainerApps}${resourceToken}-sampleapp'
