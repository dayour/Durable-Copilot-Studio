...
async def main():
    ...
    if not endpoint:
        ...
        logger.info("If you are using windows powershell, run: $env:ENDPOINT=\"<schedulerEndpoint>\"")
        logger.info("If you are using bash, run: export ENDPOINT=\"<schedulerEndpoint>\"")
        return
